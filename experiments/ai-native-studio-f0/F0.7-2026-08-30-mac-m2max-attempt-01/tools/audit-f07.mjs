...
const stagingApp = '/Users/mengyingli/Documents/ChatGPT/BlenderFilmStudio-F0-workspace/F0.7-packages/staging/Film Studio Engine F0.app';
const dmg = '/Users/mengyingli/Documents/ChatGPT/BlenderFilmStudio-F0-workspace/F0.7-packages/Film-Studio-Engine-F0-5.2.1-unsigned.dmg';
...
for (const [file, field] of [
  ['tool-freeze.json', 'freezeHash'], ['formal-start.json', 'formalStartHash'], ['package/01-normalization.json', 'normalizationHash'],
  ['package/02-create-dmg.json', 'processHash'], ['package-manifest.json', 'manifestHash'], ['roundtrip.json', 'roundtripHash'],
...
check('packageAdmissionCount', packageAdmissions.length === 5);
...
const codesignText = `${readFileSync(resolve(evidence, 'package/04-codesign.stdout.log'), 'utf8')}\n${readFileSync(resolve(evidence, 'package/04-codesign.stderr.log'), 'utf8')}`;
const spctlText = `${readFileSync(resolve(evidence, 'package/04-spctl.stdout.log'), 'utf8')}\n${readFileSync(resolve(evidence, 'package/04-spctl.stderr.log'), 'utf8')}`;
