...
const mountpoint = '/Users/mengyingli/Documents/ChatGPT/BlenderFilmStudio-F0-workspace/F0.7-mount-attempt-03';
...
writeHashed(resolve(evidence, 'package/01-import.json'), {
  ...
  dmg: { path: dmg, bytes: statSync(dmg).size, sha256: shaFile(dmg) }, packageCreatedInAttempt03: false,
}, 'importHash');
...
const installUninstall = writeHashed(resolve(evidence, 'install-uninstall.json'), {
  ...
  installedPayloadBeforeUninstall, installedPayloadBeforeUninstallNormalized,
