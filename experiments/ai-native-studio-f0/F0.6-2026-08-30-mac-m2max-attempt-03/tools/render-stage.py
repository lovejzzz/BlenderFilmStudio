...
EXPECTED_SOURCE_SHA = os.environ["F06_SOURCE_SHA"]
EXPECTED_JOB_HASH = os.environ["F06_JOB_HASH"]
...
EXPECTED_BUILD_HASH = "fa1b578bb421"
...
source = repository / "experiments/ai-native-studio-f0/F0.6-2026-08-30-mac-m2max-attempt-02/regression/f04/b01/artifacts/scene.blend"
...
print(f"F05_RENDER_CALL_BEGIN stage={args.stage.upper()} renderCall=1", flush=True)
