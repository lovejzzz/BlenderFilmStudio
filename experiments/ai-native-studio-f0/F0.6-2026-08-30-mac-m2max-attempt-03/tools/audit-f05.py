...
SOURCE_SHA = os.environ["F06_SOURCE_SHA"]
...
source = root / "experiments/ai-native-studio-f0/F0.6-2026-08-30-mac-m2max-attempt-02/regression/f04/b01/artifacts/scene.blend"
...
receipt_checks = {
    ...
    "interruptedProcess": valid_self(evidence / "processes/02-final-interrupted.json", "processHash") and interrupt_process["status"] == "INTERRUPTED" and interrupt_process["observedRenderCalls"] == 0,
...
process_checks = {
    ...
    "renderCallsExact": preview_process["observedRenderCalls"] + interrupt_process["observedRenderCalls"] + final_process["observedRenderCalls"] == 2,
...
resource_checks = {
    ...
    "observedRenderCalls": cost["observedRenderCalls"] == 2,
}
