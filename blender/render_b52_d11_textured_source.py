#!/usr/bin/env python3
"""Render one preregistered B52-D11 real-textured multipart source cell."""
...
def main() -> None:
    ...
    scene.name = f"BFS_D11_{args.fixture}_F{args.frame}_R{args.repeat}"
    ...
    world = bpy.data.worlds.new("BFS_D11_WORLD")
    ...
    body = {
        "schemaVersion": "bfs.blenderRealTexturedTemporalSourceReport.v0.1",
    ...
    print(f"BFS_B52_D11_SOURCE_OK fixture={args.fixture} frame={args.frame} repeat={args.repeat} exr={body['output']['sha256']}", flush=True)
