  ...
  return (
    <main className="b52-page">
      <header className="topbar">
        ...
        <nav aria-label="Blender 5.2 研究导航"><Link href="/">技术基线</Link><a href="#matrix-52">技术域</a><a href="#roadmap">路线图</a><Link className="route-tab cost-route" href="/cost-model">成本</Link><Link className="route-tab agenda-route" href="/research-agenda">研究路线</Link></nav>
