  ...
  return (
    <main className="b52-page">
      <header className="topbar">
        ...
        <nav aria-label="Blender 5.2 研究导航"><Link href="/">技术基线</Link><Link className="route-tab ain-route" href="/ai-native-studio-design">AI 原生 Studio</Link><a href="#matrix-52">技术域</a><Link className="route-tab cost-route" href="/cost-model">成本</Link><Link className="route-tab agenda-route" href="/research-agenda">研究路线</Link><Link className="route-tab spec-route" href="/spec-v0-1">规格 v0.1</Link><Link className="route-tab compiler-route" href="/compiler-v0-1">编译实验</Link><Link className="route-tab" href="/pixel-v0-1">像素实验</Link><Link className="route-tab actor-route" href="/actor-v0-1">角色实验</Link><Link className="route-tab contact-route" href="/contact-v0-1">接触实验</Link><Link className="route-tab" href="/grasp-v0-1">手指抓握</Link><Link className="route-tab" href="/blender-pass-adapter-v0-1">D10.1 Pass Adapter</Link><Link className="route-tab" href="/blender-temporal-composition-v0-1">D11 组合反例</Link></nav>
