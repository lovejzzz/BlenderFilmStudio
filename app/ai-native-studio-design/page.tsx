  ...
  return (
    <main className="ain-page">
      ...
      <section className="section ain-sources" id="sources">
        ...
        <div className="ain-next"><span>NEXT AUTHORIZED RESEARCH</span><div><h3>PB.1 · VALIDATION ONLY</h3><p>`lovejzzz/film-engine` C1已完成并通过59/59 audit。下一步已收缩为不改engine源码、不写engine remote的PB.1：一次read-only clone、本地LFS/dependency materialization、一次clean native build和最多两个零渲染identity/config starts。该v0.2协议仍等owner逐项授权；PB.2–PB.7、release、签名、公证和DMG继续禁止。</p><Link href="/ai-native-studio-handoff">打开PB.1授权边界 →</Link></div></div>
      </section>
