  ...
  return (
    <main className="ain-page">
      ...
      <section className="section ain-sources" id="sources">
        ...
        <div className="ain-next"><span>NEXT AUTHORIZED RESEARCH</span><div><h3>REPOSITORY CREATION · EXPLICIT AUTHORIZATION</h3><p>Post-F0 charter 已在 commit `6a38ca3b…` 冻结，machine contract SHA-256 `7280a7d1…` 绑定七个 accepted gates、15 个 retained outcomes 与 PB.1–PB.7。下一步需要明确 repository owner、private/public visibility、create 和 full-history first-push 权限。签名、公证、unsigned DMG distribution 与 Phase B mutation 不自动包含。</p><Link href="/ai-native-studio-handoff">打开授权边界 →</Link></div></div>
      </section>
