...
export default function AutoexecBoundaryPage() {
  return <main className="contact-page security-page">
    ...
    <footer><div><span className="brand-mark">BFS</span><b>B36 Autoexec Boundary</b></div><p>registered Text blocked · parser sandbox still open</p><Link href="/research-agenda">继续 OS worker containment →</Link></footer>
  </main>;
}
