...
export default function WorkerContainmentPage() {
  return <main className="contact-page security-page">
    ...
    <footer><div><span className="brand-mark">BFS</span><b>B37 Worker Containment Canary</b></div><p>deprecated prototype support · inherited env counterexample</p><Link href="/worker-launch-contract-v0-1">继续 B38 launcher contract →</Link></footer>
  </main>;
}
