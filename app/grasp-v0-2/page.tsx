...
export default function GraspV02Page() {
  return <main className="contact-page">
    ...
    <footer><div><span className="brand-mark">BFS</span><b>B05 Compiled Grasp</b></div><p>Automation + visibility pass · dynamics false · human review pending</p><Link href="/research-agenda">继续研究路线 →</Link></footer>
  </main>;
}
