    ...
    <main>
      <header className="topbar">
        ...
        <nav aria-label="研究导航">
          ...
          <Link className="route-tab" href="/blender-projective-depth-formal-invalidation-v0-1">D12.14-H2 正式调用失效</Link><Link className="route-tab" href="/formal-runner-admission-totality-v0-1">B53-E1 准入总路径</Link><Link className="route-tab" href="/admission-gated-native-compiler-v0-1">B54-E1 原生编译器准入</Link><Link className="route-tab" href="/budgeted-native-child-pid-receipt-v0-1">B55-E1 原生 PID Receipt</Link><Link className="route-tab" href="/production-compiler-entry-promotion-v0-1">B56-E1 生产编译入口</Link><Link className="route-tab" href="/production-disk-jit-readmission-v0-1">B57-E1 磁盘即时再准入</Link><Link className="route-tab" href="/cinematic-render-repro-cost-v0-1">B61-E1 Cycles 复现与成本</Link><Link className="route-tab" href="/b62-phase0-terminal-proof-v0-1">B62 Phase 0 终端实验</Link><Link className="route-tab" href="/b62-camera-quality-holdout-v0-1">B62 Camera Q1 留出拒绝</Link>
        </nav>
