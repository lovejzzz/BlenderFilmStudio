...
const gaps: {
  ...
  },
  {
    ...
    known: 'B10 关闭 6 个 symlink/输出逃逸；B11 首轮证伪 hash-valid 资产可偷带求值行为，修复后 object/shape-key driver、constraint、physics、action、外链、override、autoexec 9/9 拒绝。',
    missing: '解析器漏洞、资源耗尽、OS 进程隔离、包供应链、签名审批、dry-run、回滚和完整 MCP 工具授权仍未实现。',
...
export default function ResearchAgendaPage() {
  ...
  return (
    <main className="agenda-page">
      ...
      <footer><div><span className="brand-mark">BFS</span><b>Falsifiable Research Agenda</b></div><p>Research tab · Snapshot: 2026-08-26 · Negative results are evidence</p><Link href="/asset-security-v0-1">查看最新资产证据 →</Link></footer>
    </main>
  );
}
