...
const gaps: {
  ...
  },
  {
    ...
    known: 'JSON Schema 2020-12 可做结构验证；USD 可做资产引用、分层、变体与非破坏性 override。',
    missing: '角色、镜头、接触、灯光、时间、资产版本、单位、权限和未知字段的正式语义尚未定义。',
    artifact: 'SceneSpec v0.1 + 20 Valid/Invalid Fixtures',
