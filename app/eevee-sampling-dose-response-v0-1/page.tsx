...
export default function EeveeSamplingDoseResponsePage() {
  return <main className="contact-page dose-page">
    ...
    <section className="section contact-limits" id="next"><div className="section-index">04 / 下一可证伪边界</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B19 COMPLETED · CANDIDATES FALSIFIED</p><h2>RNA 候选已经测试，<br /><span>下一步看进程历史。</span></h2></div><p>B19 的 Fast GI × reprojection 四个 cells 全部非 exact；同时关闭也未修复。下一步不再挑 setting，而隔离顺序帧历史与 fresh-process 单帧。</p></div><div className="contact-artifacts"><a href={`${repo}experiments/eevee-sampling-dose-response-v0-1/results.json`}><span>RESULT</span><b>vector · 13 attacks ↗</b></a><a href={`${repo}experiments/eevee-sampling-dose-response-v0-1/evidence/S01.sequence.comparison.json`}><span>S01 COUNTEREXAMPLE</span><b>frame 89 · 30 codes ↗</b></a><a href={`${repo}research/2026-08-26-b18-eevee-sampling-dose-response-result.md`}><span>RESULT NOTE</span><b>measured pattern ↗</b></a><Link href="/eevee-gi-reprojection-factorial-v0-1"><span>B19</span><b>GI × reprojection result →</b></Link></div></section>
