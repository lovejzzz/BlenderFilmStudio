...
export default function GraspV01Page() {
  return <main className="contact-page">
    ...
    <footer><div><span className="brand-mark">BFS</span><b>B05 Articulated Grasp</b></div><p>GraspSpec v0.1 · historical feasibility spike</p><Link href="/grasp-v0-2">查看正式编译结果 →</Link></footer>
  </main>;
}
