  ...
  return (
    <main className="actor-page">
      ...
      <section className="section actor-limits" id="limits">
        <div className="section-index">06 / 明确边界与下一步</div>
        <div className="actor-heading dark-heading"><div><p className="eyebrow dark"><span /> DO NOT OVERCLAIM</p><h2>下一关不是“更漂亮”。<br />是<span>进入场景合同。</span></h2></div><p>当前脚底 0 m 滑移只表示 socket 自身没动，并没有测量它与场景地面的误差。B03/B04 必须让 SceneSpec 拥有目标，编译器才能验证角色—场景关系。</p></div>
        <div className="actor-limit-grid"><article><span>NOT PROVEN</span><h3>近景人物真实感</h3><p>皮肤、眼睛、牙齿、舌头、头发、肌肉、口型、情绪与微表演。</p></article><article><span>NOT PROVEN</span><h3>接触可信度</h3><p>手指抓握、碰撞、掌心贴合、目标相对旋转、软组织与布料响应。</p></article><article className="next"><span>NEXT BENCHMARK</span><h3>ActorSpec → SceneSpec</h3><p>B03 场景目标眼神；B04 全身拿取。测量脚底、手掌、视线与目标的逐帧相对误差。</p></article></div>
