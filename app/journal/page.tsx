...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B29 · PASS-DOMAIN COUNTEREXAMPLE</p><h2>覆盖 mode 与画面 mode，<br /><span>并非一一耦合。</span></h2></div><p>144 次 render 同时读取 PNG、Combined、Crypto 与 data passes：141 次符合冻结 tuple，3 次出现 PNG/Combined REFERENCE + Crypto ALTERNATE。Depth/Normal/Position 144/144 exact；按预注册优先级，三个反例否证纯耦合定位。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/pass-domain-localization-v0-1"><span>B29 RESULT</span><b>8 passes × 144 renders →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>fixed-jitter mechanism probe →</b></Link></div></section>
