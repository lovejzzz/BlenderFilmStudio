...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B13 · COMPILE RECEIPT</p><h2>结构哈希已经稳定。<br /><span>工具链与产物也被绑定。</span></h2></div><p>B01/B02 各两次真实 Blender 净构建，四份 receipt 全部通过 19 项独立检查；10 个预注册与 2 个现场补充攻击通过。它仍是 unsigned local receipt，不是远程证明。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/compile-receipt-v0-1"><span>B13 RESULT</span><b>编译收据证据 →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>未关闭缺口 →</b></Link></div></section>
