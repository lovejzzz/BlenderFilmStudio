...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B44 → B45-C1 · COMPILED SCENE TO FLOAT PIXELS</p><h2>`.blend` 字节不同。<br /><span>解码浮点像素完全相同。</span></h2></div><p>首轮 B45 的 EXR media-type 与 null-report 缺陷被原样保留；C1 在不改帧、采样或阈值的前提下完成四次真实 Blender 渲染。两组 scene-linear float32 pair exact，独立 audit 重新解码全部输出并通过 16/16 攻击。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>三道门与实验纪律 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>失败与修正记录 ↗</b></a><Link href="/codex-worker-pixels-v0-1"><span>B45-C1 PIXELS</span><b>4/4 renders · 2/2 exact →</b></Link><Link href="/codex-to-blender-worker-v0-1"><span>B44 COMPILE CHAIN</span><b>source `.blend` evidence →</b></Link></div></section>
