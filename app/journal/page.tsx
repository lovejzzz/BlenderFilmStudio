...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B34 · INDEPENDENT-HUMAN PACKAGE</p><h2>载体与盲法已过门。<br /><span>观察者仍是 0/18。</span></h2></div><p>13 个新 Blender PID / 1,872 EXR 生成 NATURAL/Q4/Q8 六秒片段；三条 carrier 共 432/432 RGB exact，24/24 attacks。独立 audit 首轮 bug 被保留，修复后全量通过；开发者浏览器 pilot 不计入 human result。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/human-quadrature-review-v0-1"><span>B34 PACKAGE</span><b>carrier · blinding · audit →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>18 observers →</b></Link></div></section>
