...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B47 → B48-D1/D2 → B48 · REPRESENTATION TO OPERATING POINT</p><h2>不猜“最佳参数”。<br /><span>让独立参考与真实成本共同选择。</span></h2></div><p>B48 用 14 个隔离 worker 在两个未见帧上比较 32/128 spp raw 与 OIDN。每帧由三个独立 512-spp reference 建立本地噪声地板；只有 128-spp raw 在 linear、log-luminance 与 edge 三项指标上同时通过两个场景。独立 audit 字节级复算一致并通过 18/18 攻击。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>三道门与实验纪律 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>失败与修正记录 ↗</b></a><Link href="/quality-cost-holdout-v0-1"><span>B48 QUALITY × COST</span><b>128 raw selected · 2/2 →</b></Link><Link href="/codex-worker-production-passes-v0-1"><span>B47 PRODUCTION PASSES</span><b>multipart predecessor →</b></Link></div></section>
