...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B38 · WORKER LAUNCH CONTRACT</p><h2>启动语义可以冻结。<br /><span>Backend 隔离仍未执行。</span></h2></div><p>三个 deep-reordered request 得到 3/3 相同 canonical plan；11-key 环境排除了 parent canary，25/25 attacks 与独立 audit 通过。真实 host 仍被 100 GiB disk reserve 拒绝，因此没有启动 Blender/container，也没有 backend claim。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/worker-launch-contract-v0-1"><span>B38 LAUNCHER</span><b>3/3 canonical · 25/25 attacks →</b></Link><Link href="/worker-containment-v0-1"><span>B37 SECURITY</span><b>16/16 blocked · env counterexample →</b></Link></div></section>
