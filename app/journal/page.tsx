...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B21 · EXR32 × PNG8</p><h2>Float EXR 已经漂移。<br /><span>PNG 不是起点。</span></h2></div><p>36 个唯一 PID 各 render 一次、从同一 Render Result 保存两种格式。EXR32 与 PNG8 都是 21/36 exact，且每个 pair 的通过/失败标签完全一致；21/21 攻击通过。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/dual-output-localization-v0-1"><span>B21 RESULT</span><b>EXR / PNG 定位 →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>并发候选 →</b></Link></div></section>
