...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B40 → C5 · HOST CAPACITY ADMISSION</p><h2>模拟器通过。<br /><span>Host 资格被四道门拒绝。</span></h2></div><p>宿主磁盘、VM memory、VM CPU 和 Docker storage 同时 blocked；零 swap、零竞争容器与 qemu-x86_64 通过。五个 rejected tool attempts 暴露 parser、alias、failure projection、identity 和 self-hash defects；C5 才通过 14/14、JSON replay 与独立 audit。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/worker-host-capacity-v0-1"><span>B40 CAPACITY</span><b>four blockers · 14/14 replay →</b></Link><Link href="/linux-worker-preflight-v0-1"><span>B39 ARCHITECTURE</span><b>failure retained · correction PASS →</b></Link></div></section>
