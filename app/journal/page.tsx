...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B28 · SAME-PID MODE SWITCH</p><h2>同一个 Blender 进程，<br /><span>也无法锁住输出模式。</span></h2></div><p>12 个新 PID 各连续渲染 frame 38 十二次：12/12 PID 都出现 REFERENCE 与 ALTERNATE，42/132 个相邻调用发生切换，没有第三模式。异常边界已推进到 render invocation 或更底层；B26 正式观察者仍为 0/18。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/repeated-frame-mode-switch-v0-1"><span>B28 RESULT</span><b>12 PID × 12 renders →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>lower-level mechanism boundary →</b></Link></div></section>
