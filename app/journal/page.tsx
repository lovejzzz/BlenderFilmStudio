...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B37 · WORKER CONTAINMENT</p><h2>能力 deny 已实测。<br /><span>环境继承反例也成立。</span></h2></div><p>六个真实 Blender PID 显示 deprecated SBPL 阻断 16/16 受控能力，但继承的假 secret 仍 2/2 可见；launcher 清理后才是 0/2。九个 attacks 与独立 audit 通过，但它仍不是支持的生产 sandbox。B35 人类证据继续停在 0/18。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/worker-containment-v0-1"><span>B37 SECURITY</span><b>16/16 blocked · env counterexample →</b></Link><Link href="/delayed-disclosure-review-v0-2"><span>B35 HUMAN GATE</span><b>collection not open · 0/18</b></Link></div></section>
