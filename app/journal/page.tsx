...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B18 · SAMPLING DOSE RESPONSE</p><h2>简单阈值被证伪。<br /><span>一次 exact 不能叫确定。</span></h2></div><p>1/2/4/8/16/32 samples 的 exact 向量是 F,T,F,F,F,F。sample=1 没有复现 B17，sample=2 恰好 exact，其他级别均失败；13/13 攻击通过。下一步必须增加重复深度。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/eevee-sampling-dose-response-v0-1"><span>B18 RESULT</span><b>剂量响应反例 →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>重复实验设计 →</b></Link></div></section>
