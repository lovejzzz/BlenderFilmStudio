...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B34 · PUBLIC HASH UNBLINDING</p><h2>载体工程已经过门。<br /><span>公开盲法被反证。</span></h2></div><p>public manifest 的 method→carrier SHA 与 observer HTML 的 CLIP→SHA 可直接 join；18/18 session 全恢复，不需要 sealed mapping。B34 的 1,872 render 与 RGB-exact 事实保留，但正式收集在 observer 1 之前停止。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/human-quadrature-review-v0-1"><span>B34 COUNTEREXAMPLE</span><b>18 / 18 unblinded →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>delayed disclosure →</b></Link></div></section>
