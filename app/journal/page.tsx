...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B32 · DETERMINISTIC QUADRATURE COST CURVE</p><h2>无效尝试保留。<br /><span>新帧正式曲线通过。</span></h2></div><p>v0.1 因 25,921-pixel mask tie 被判 invalid；v0.2 更换四个新 frame 与 exact-top-k 协议，重跑 28 PID / 112 EXR。Q4 约 4.07× time、edge mean 1.2706×；Q8 约 8.14× time、edge mean 0.9510×。29/29 attacks 通过。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/quadrature-cost-holdout-v0-2"><span>B32 RESULT</span><b>failure + cost curve →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>temporal + human boundary →</b></Link></div></section>
