...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B25 · COMPLETE-SEQUENCE HOLDOUT</p><h2>时间子门 429/429。<br /><span>总门仍被 2 个静态 pair 否决。</span></h2></div><p>三次完整 144 帧渲染、三个唯一 PID。时间残差全部通过，但 frame 38 的 A–B 与 A–C 各有 17 个 changed pixels，超过冻结的 ≤16 空间门；19/19 攻击通过，阈值不回写。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/temporal-residual-holdout-v0-1"><span>B25 RESULT</span><b>temporal pass × static fail →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>blind review × root cause →</b></Link></div></section>
