...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B31 · EDGE-REFERENCE COST HOLDOUT</p><h2>稳定性收益成立。<br /><span>边缘数值代价也成立。</span></h2></div><p>四个未见 frame 的 CENTER/NATURAL edge RMSE 为 2.169–2.864×，全部超过冻结 1.5 门；reference reliability 4/4 通过。结论只属于 scene-linear edge proxy，不等于肉眼画质倍率。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/sampling-quality-holdout-v0-1"><span>B31 RESULT</span><b>4 frames × dual proxy →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>multi-jitter ensemble →</b></Link></div></section>
