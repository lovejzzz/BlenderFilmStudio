...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B27 · FRAME-HISTORY ISOLATION</p><h2>连续历史没有解释 frame 38。<br /><span>两个稳定模式留下更窄边界。</span></h2></div><p>24 个新 PID 完成 468 次 render：HISTORY 2/12、DIRECT 3/12 超门，Fisher p≈1。五个失败输出与 B25-A 逐像素相同；下一步转向同 PID 内重复 render，B26 正式观察者仍为 0/18。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/frame-history-isolation-v0-1"><span>B27 RESULT</span><b>history × direct × two modes →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>same PID repeated frame 38 →</b></Link></div></section>
