...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B44 → B45-C1 → B46 · FLOAT PIXELS TO ORDERED SEQUENCE</p><h2>帧像素完全相同。<br /><span>帧间变化也完全相同。</span></h2></div><p>B46 用四个主 worker 生成两组 8 帧序列，16/16 frame pairs 与 14/14 float32 temporal-delta pairs exact。故障 worker 留下一个不可晋级帧；新容器与空目录恢复 8/8 exact。独立 audit 重解码 40 个成功 EXR 并通过 21/21 攻击。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>三道门与实验纪律 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>失败与修正记录 ↗</b></a><Link href="/codex-worker-sequence-v0-1"><span>B46 SEQUENCE</span><b>16/16 frames · 14/14 deltas →</b></Link><Link href="/codex-worker-pixels-v0-1"><span>B45-C1 PIXELS</span><b>single-frame predecessor →</b></Link></div></section>
