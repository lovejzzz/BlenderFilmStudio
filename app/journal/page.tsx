...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B30 · FIXED-JITTER INTERVENTION</p><h2>严格稳定获得支持。<br /><span>采样质量仍然开放。</span></h2></div><p>CENTER 在 12 个 PID、144 次调用中全部命中冻结 hash；NATURAL 在 10/12 PID 内复现切换。它同时改变全幅约 13.18 万个像素，所以只能晋级为稳定性干预，不是画质或电影感结论。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/fixed-jitter-intervention-v0-1"><span>B30 RESULT</span><b>24 PID × 288 renders →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>sampling-quality boundary →</b></Link></div></section>
