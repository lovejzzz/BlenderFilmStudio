...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B22 · FIXED THREADS 1 × 8</p><h2>一个线程仍然漂移。<br /><span>公开开关不是充分答案。</span></h2></div><p>72 个唯一 PID 各 render 一次并保存 EXR32。T01 为 19/36 exact，T08 为 22/36 exact；19/19 攻击通过。下一步分离进程初始化与同进程 repeated render。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/eevee-thread-count-factorial-v0-1"><span>B22 RESULT</span><b>1 × 8 threads →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>repeated render 边界 →</b></Link></div></section>
