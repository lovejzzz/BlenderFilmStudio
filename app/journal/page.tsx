...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B26 · BLINDED REVIEW PACKAGE</p><h2>三条播放载体逐帧 exact。<br /><span>人类结果仍是 0。</span></h2></div><p>A/B/C lossless VP9 均 144/144 RGB exact；18 个 session 实现六种顺序各三次，20/20 攻击通过。映射已密封，正式观察者 0/18，因此只能写 package ready / human pending。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/blind-temporal-review-v0-1"><span>B26 PACKAGE</span><b>lossless × blinded × pending →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>recruit × isolate frame 38 →</b></Link></div></section>
