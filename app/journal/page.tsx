...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B20 · PROCESS HISTORY</p><h2>每帧都重启 Blender，<br /><span>仍然不能保证 exact。</span></h2></div><p>39 个唯一 PID 完成 468 帧。FRESH 的 26/36 虽高于 HISTORY 的 18/36，但两者都没有通过零容差门；18/18 攻击通过。下一步定位 scene-linear float buffer 与 PNG8 输出边界。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/eevee-process-history-isolation-v0-1"><span>B20 RESULT</span><b>进程隔离反证 →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>float / PNG 边界 →</b></Link></div></section>
