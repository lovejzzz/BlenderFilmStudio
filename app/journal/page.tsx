...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B14 · COMPLETE REVIEW DAILIES</p><h2>收据绑定的场景，<br /><span>已经跑完整个时间轴。</span></h2></div><p>B02 由真实 Blender 输出 144/144 帧并封装成可播放 6 秒样片，10/10 攻击通过。它被严格标为 Eevee review proxy；人类电影感评审仍然 pending。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/review-dailies-v0-1"><span>B14 RESULT</span><b>完整样片证据 →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>未关闭缺口 →</b></Link></div></section>
