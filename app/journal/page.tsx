...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B17 · SAMPLING FACTORIAL</p><h2>单采样恢复 exact。<br /><span>但画质明显退化。</span></h2></div><p>1/32 samples × dither 0/1 的完整因子实验共渲染 1,152 帧。两组 sample=1 都 144/144 像素 exact，两组 sample=32 都非 exact；12/12 攻击通过。这是因果定位，不是生产修复。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/eevee-sampling-factorial-v0-1"><span>B17 RESULT</span><b>采样因果证据 →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>下一可证伪边界 →</b></Link></div></section>
