...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B23 · SAME PID REPEATED RENDER</p><h2>不重启也会漂移。<br /><span>严格与感知必须分开。</span></h2></div><p>72 个唯一 PID、144 次 float render。同一进程同一帧的 WITHIN gate 仅 59/108 exact；20/20 攻击通过。下一步用独立 holdout 定义生产容差，不在同一数据上调门槛。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/eevee-repeated-render-boundary-v0-1"><span>B23 RESULT</span><b>same-PID boundary →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>production tolerance →</b></Link></div></section>
