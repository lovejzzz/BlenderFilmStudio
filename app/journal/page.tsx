...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B42 → C1 · LINUX/AMD64 COMPILER REPRO</p><h2>四次净构建通过。<br /><span>篡改计划被拒绝。</span></h2></div><p>B42 首轮因只读嵌套 mountpoint 与 analyzer 缺陷失败并保留。预注册的 C1 只修正这两项；B01/B02 各两次真实 Blender worker 编译复现冻结 structure hash，独立 audit 对 tools、outputs、plans 全部 MATCH。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/linux-amd64-compiler-repro-v0-1"><span>B42 COMPILER</span><b>4/4 builds · tamper rejected →</b></Link><Link href="/worker-host-capacity-v0-1"><span>B40 CAPACITY</span><b>admission chain →</b></Link></div></section>
