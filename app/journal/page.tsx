...
export default function JournalPage() {
  return <main className="contact-page">
    ...
    <section className="section contact-limits"><div className="section-index">02 / 最新结果</div><div className="contact-heading dark-heading"><div><p className="eyebrow dark"><span /> B24 · INDEPENDENT HOLDOUT</p><h2>世界身份保持 exact。<br /><span>像素差异保持 bounded。</span></h2></div><p>24 个未见帧、72 个唯一 PID。EXR32 与 PNG8 均 72/72 通过预冻结 envelope，strict exact 各 70/72；22/22 攻击通过，没有修改阈值。</p></div><div className="contact-artifacts"><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/RESEARCH_CHARTER.md"><span>CHARTER</span><b>目标实验精神 ↗</b></a><a href="https://github.com/lovejzzz/BlenderFilmStudio/blob/main/research/lab-journal.md"><span>FULL JOURNAL</span><b>完整文字记录 ↗</b></a><Link href="/production-tolerance-holdout-v0-1"><span>B24 RESULT</span><b>derivation × holdout →</b></Link><Link href="/research-agenda"><span>AGENDA</span><b>temporal playback →</b></Link></div></section>
