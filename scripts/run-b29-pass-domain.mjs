...
async function validate(overrides = {}) {
  ...
  const expected = { specSha, b28Sha: spec.evidenceBasis.b28ResultsSha256, pilotReportSha: spec.evidenceBasis.pilotReportSha256, pilotAnalysisSha: spec.evidenceBasis.pilotAnalysisSha256, pilotRendererSha: spec.evidenceBasis.pilotRendererSha256, pilotAnalyzerSha: spec.evidenceBasis.pilotAnalyzerSha256, reviewSha: frozen.reviewRenderSpecSha256, blenderSha: frozen.blenderSha256, ocioSha: frozen.ocioSha256, sceneSha: frozen.sceneBlendSha256, planHash: frozen.planHash, structureHash: frozen.structureHash, configuratorSha: frozen.configuratorSha256, rendererSha: tools.rendererSha256, classifierSha: tools.classifierSha256, runnerSha: tools.runnerSha256, threads: 8, passCount: 9, processOrder: spec.design.processOrder, firstPid: base.processId, callOrder: Array.from({ length: 12 }, (_, index_) => index_ + 1), saves: 24, width: 960, firstPngSha: base.report.outputs[0].png.sha256, indexSha: await sha256File(indexPath), contractHash, humanPending: true, ...overrides };
