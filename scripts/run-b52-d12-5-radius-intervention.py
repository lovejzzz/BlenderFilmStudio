#!/usr/bin/env python3
"""Single-use formal runner for B52-D12.5."""
...
def main()->None:
    ...
    if free-projected<reserve:raise RuntimeError("D12.5 disk admission rejected")
