#!/usr/bin/env python3
"""Extract one B52-D11 multipart source pair into canonical D9.1 arrays."""
...
def main() -> None:
    ...
    body = {
        "schemaVersion": "bfs.blenderRealTexturedTemporalAdapterReport.v0.1",
    ...
    print(f"BFS_B52_D11_ADAPTER_OK fixture={args.fixture} repeat={args.repeat} motion={records['motion']['sha256']}")
