#!/usr/bin/env python3
"""Encode one B52-D11.1 Python-resolved RGBA32 array as Raw FLOAT EXR."""
...
def main() -> None:
    ...
    body = {
        "schemaVersion": "bfs.blenderNearestIntegerTemporalRecoveryEncoderReport.v0.1",
    ...
    print(f"BFS_B52_D11_1_ENCODER_OK fixture={args.fixture} sourceRepeat={args.source_repeat} exact={exact}")
    if not exact:
        raise SystemExit(1)
