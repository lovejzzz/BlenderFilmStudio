...
RETAINED_FAILURE_04 = RESEARCH / "experiments/unstaged-physical-realism/RC4-2026-09-01-development-attempt-04/failure-receipt.json"
EXPECTED_WORK = "/Users/mengyingli/Documents/ChatGPT/BlenderFilmStudio-PostPB7-workspace/RC4-development-attempt-05"
EXPECTED_EVIDENCE = "/Users/mengyingli/Documents/ChatGPT/MyBlenderFilmStudio/experiments/unstaged-physical-realism/RC4-2026-09-01-development-attempt-05"
...
def main():
    ...
    checks = {
        ...
        "retainedAttempt04Failure": RETAINED_FAILURE_04.is_file() and json.loads(RETAINED_FAILURE_04.read_text(encoding="utf-8"))["status"] == "FAIL_DIRECT_VISUAL_REVIEW_GLASS_TRANSMISSION_NOISE",
