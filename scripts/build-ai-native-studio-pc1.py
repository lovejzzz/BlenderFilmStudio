...
def render_frame(scene, frame, camera_name, path):
    scene.frame_set(frame)
...
for view in spec["protectedViews"]:
    render_frame(scene, view["frame"], view["camera"], args.evidence_root / "baseline" / f"frame-{view['frame']:04d}.png")
scene.frame_set(1)
...
for view in spec["protectedViews"]:
    render_frame(scene, view["frame"], view["camera"], args.evidence_root / "derived" / f"frame-{view['frame']:04d}.png")
