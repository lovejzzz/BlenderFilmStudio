...
if (!validSelf(context, 'contextHash') || context.status !== 'PREREGISTERED_C3_BEFORE_ATTEMPT04_SCENE_MUTATION') throw new Error('CONTEXT');
if (!validSelf(freeze, 'freezeHash') || freeze.status !== 'FROZEN_C3_BEFORE_ATTEMPT04_SCENE_MUTATION') throw new Error('FREEZE');
