...
if (!validSelf(context, 'contextHash') || context.status !== 'PREREGISTERED_C4_BEFORE_ATTEMPT05_SCENE_MUTATION') throw new Error('CONTEXT');
if (!validSelf(freeze, 'freezeHash') || freeze.status !== 'FROZEN_C4_BEFORE_ATTEMPT05_SCENE_MUTATION') throw new Error('FREEZE');
