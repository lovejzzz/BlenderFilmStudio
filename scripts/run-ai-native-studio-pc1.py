...
FREEZE_URI = "specs/ai-native-studio-pc1-tool-freeze.v0.1.json"
EVIDENCE_URI = "experiments/ai-native-studio-post-pb7/PC.1-2026-08-31-mac-m2max-attempt-01"
WORK_ROOT = Path("/Users/mengyingli/Documents/ChatGPT/BlenderFilmStudio-PostPB7-workspace/PC.1-2026-08-31-mac-m2max-attempt-01")
...
def execute(args):
    ...
    env = {**os.environ, "HOME": str(home), "TMPDIR": str(tmp) + "/", "BLENDER_USER_CONFIG": str(config), "BLENDER_USER_SCRIPTS": str(scripts), "PYTHONNOUSERSITE": "1", "LC_ALL": "C", "LANG": "C"}
