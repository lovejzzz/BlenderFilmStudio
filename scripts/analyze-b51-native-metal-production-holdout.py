...
def full_analysis(spec: dict, receipt: dict, output: Path) -> None:
    receipt_root = output.parent
...
def main() -> None:
    ...
    if args.check_canary:
        ...
        full_analysis(spec, json.loads(args.receipt.read_text(encoding="utf-8")), args.output)
